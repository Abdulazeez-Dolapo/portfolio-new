...
import { formatDate, getStrapiMedia } from '@/app/[lang]/blog/utils/api-helpers'
import { postRenderer } from '@/app/[lang]/blog/utils/post-renderer'
	...
	return (
		<article className='space-y-8 dark:bg-black dark:text-gray-50'>
			...
			<div className='dark:text-gray-100'>
				...
				{article.attributes.blocks.map((section: any, index: number) =>
